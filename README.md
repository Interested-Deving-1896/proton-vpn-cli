...
This is our Proton VPN CLI! Have fun on your terminal.
...
If you are using NetworkManager as your VPN connection backend, you'll need to
install some distribution packages before being able to pip install the required
dependencies to set up your development environment. You can find more
information on the
...
of the proton-vpn-network-manager component.
